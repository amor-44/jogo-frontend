        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col items-center justify-center">
          ...
          {!isSubmitted ? (
            ...
            <div className="w-full max-w-sm flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C2C5E] mb-2">تم الإرسال بنجاح!</h3>
              <p className="text-gray-500 text-xs leading-relaxed mb-6">
                قمنا بإرسال تعليمات إعادة تعيين كلمة المرور إلى البريد: <br />
                <strong className="text-[#2B43A1]">{email}</strong>
              </p>
              <button 
                onClick={() => setIsSubmitted(false)}
                className="text-xs text-gray-400 hover:text-gray-600 underline mb-4 cursor-pointer"
              >
                لم يصلك البريد؟ إعاده المحاولة
              </button>
            </div>
          )}
