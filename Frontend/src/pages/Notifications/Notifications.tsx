...
import { Bell, Loader2, Check, X, Inbox, MessageSquare } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-4xl mx-auto pb-10 pt-2 font-sans" dir="rtl">
      <div className="flex justify-between items-center mb-2">
        <div>
          <h1 className="text-2xl md:text-3xl font-extrabold text-[#1C2C5E] flex items-center gap-2">
            <Bell className="w-6 h-6 text-[#2B43A1]" />
            الإشعارات وطلبات التواصل
          </h1>
              ...
              >
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    ...
                    {req.message && (
                      <p className="text-xs text-gray-600 bg-gray-50 p-2.5 rounded-xl mt-2 border border-gray-100 flex items-start gap-1.5">
                        <MessageSquare className="w-3.5 h-3.5 text-[#2B43A1] shrink-0 mt-0.5" />
