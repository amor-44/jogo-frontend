        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FootballExperience = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FootballVideos_PlayerProfiles_PlayerProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Metrics_PositionScore = table.Column<int>(type: "int", nullable: false),
                    Metrics_PassingAccuracy = table.Column<int>(type: "int", nullable: false),
                    Metrics_BallControl = table.Column<int>(type: "int", nullable: false),
                    Metrics_PositioningScore = table.Column<int>(type: "int", nullable: false),
                    Metrics_MovementEfficiency = table.Column<int>(type: "int", nullable: false),
                    Metrics_DefensiveActions = table.Column<int>(type: "int", nullable: false),
                    Metrics_AttackingImpact = table.Column<int>(type: "int", nullable: false),
                    Metrics_DecisionMaking = table.Column<int>(type: "int", nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FootballVideos_PlayerProfileId",
                table: "FootballVideos",
                column: "PlayerProfileId");
