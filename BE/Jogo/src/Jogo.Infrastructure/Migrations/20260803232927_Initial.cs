    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ScoutProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FootballVideos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryPosition = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SecondaryPosition = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CurrentClub = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
